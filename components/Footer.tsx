 ...
 *
 * A server component: it holds no state and needs no interactivity, so it ships
 * zero client JS.
 *
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-[1.5fr_repeat(4,1fr)]">
          ...
          <div className="max-w-xs">
            <div className="flex items-center gap-2">
              <span
                aria-hidden="true"
                className="flex h-7 w-7 items-center justify-center rounded-md bg-brand text-xs font-bold text-white"
              >
                A
              </span>
